...
## Purpose:This script takes the clustered VSG file and matches the representative VSG Trinity name with the cluster name for each cluster. The output is a text file that has [trinity name] [tab] [Cluster name].
...
cluster_dict = {}
with open('abex7_orf_VSGs_merged.fa.clstr','r') as infile_split:
